...
from src.tagz.database import (
    create_page_in_database,
    delete_page,
    get_page_with_name,
    merge_pages_with_same_name,
    move_subpage_to_tags_database,
)
...
def setup_pages(notion, database_id):
    ...
    _ = write_content_to_page(notion, first_page_id, first_page_content)
    ...
    _ = write_content_to_page(notion, second_page_id, second_page_content)
    ...
    _ = write_content_to_page(notion, third_page_id, third_page_content)
